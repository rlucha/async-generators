...
module.exports = {
	"_args": [
		[
			...
			"/Users/roberto.lucha/code/labs/async-generators"
		]
	],
	"_from": "axios@latest",
	"_id": "axios@0.16.1",
	...
	"_shrinkwrap": null,
	"_spec": "axios",
	"_where": "/Users/roberto.lucha/code/labs/async-generators",
	"author": {
		"name": "Matt Zabriskie"
	},
	"browser": {
...
let tick = (() => {
  var _ref = _asyncGenerator.wrap(function* () {
    debugger;
    const thing = yield _asyncGenerator.await(__WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('http://www.google.com'));
    yield yield _asyncGenerator.await(thing);
  });
